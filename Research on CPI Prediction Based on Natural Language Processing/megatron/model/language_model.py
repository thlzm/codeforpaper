...
class Embedding(MegatronModule):
    ...
    def load_state_dict(self, state_dict, strict=True):
        ...
        if len(state_dict_["weight"])!=self.vocab_size:
            # print(f'Warning, word embeddings size mismatch for weight, copying a vocab size with {len(state_dict_["weight"])} '
            #       f'from checkpoint, the vocab size in current model is {self.vocab_size}.')
